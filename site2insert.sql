...
insert into ticket(ticketid,tid,status_,class_,source,dest,fare,departure_time,count_)
		values(5126,3,'unavailable','1st class','Dhaka','Dinajpur',2000, TO_DATE('2019/09/28 08:30:00', 'yyyy/mm/dd hh24:mi:ss'), 0);
		
-- Ticket bookings made at Sylhet
...
insert into booking(bid,pid,ticketid,seat_num,seat_type,booking_status,location)
		values(1009,104,5125,9,'Shulov','Booked','Sylhet');
insert into booking(bid,pid,ticketid,seat_num,seat_type,booking_status,location)
		values(1010,104,5126,10,'Shulov','Booked','Sylhet');
